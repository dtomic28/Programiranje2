...
void getExpensesOverDate(
    const vector<Expense>& expenses, vector<Expense>& expensesOverDate, unsigned int day, unsigned int month, unsigned int year)
{
...
void fillArray(vector<Expense>& array, const unsigned int size)
{
    ...
    {
        array.push_back(Expense(generateRandomFloatInRange(0.50, 150.00),
                                int(generateRandomFloatInRange(1, 31)),
                                int(generateRandomFloatInRange(1, 12)),
                                2024,
                                description));
    }
}
