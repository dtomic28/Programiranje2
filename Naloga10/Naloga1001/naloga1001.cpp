//
// Created by danijel on 5/19/2024.
//
#include <iostream>
...
bool isForOver18(Event* e)
{
    return e->getAgeGroup() == EventAgeGroup::Adult || e->getAgeGroup() == EventAgeGroup::Senior;
}
...
int main()
{
    ...
    std::cout << eventOrganizer.toString();

    eventOrganizer.sort(ascendingPrice);
    std::cout << eventOrganizer.toString();
