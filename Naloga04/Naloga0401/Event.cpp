...
{
    return ("Id: " + std::to_string(this->id) + "  " + this->title + " (" + std::to_string(this->price) + ") " +
            "Num of tickets: " + std::to_string(this->numTickets) + " Age group: " + eventAgeGroupToString(this->ageGroup));
}
