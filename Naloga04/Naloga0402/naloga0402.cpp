...
void initEvents(Event* events, Location* locations){
    ...
    events[0].setEnd(DateTime(Date::parse("29.10.2023"), Time(2, 0, 0)));
    ...
    events[1].setStart(DateTime(Date::parse("15.05.2024"), Time(14, 0, 0)));
    events[1].setEnd(DateTime(Date::parse("15.05.2024"), Time(22, 0, 0)));
    ...
    events[2].setStart(DateTime(Date::parse("20.12.2024"), Time(19, 0, 0)));
    events[2].setEnd(DateTime(Date::parse("21.12.2024"), Time(1, 0, 0)));
